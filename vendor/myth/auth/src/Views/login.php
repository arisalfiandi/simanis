                  ...
                  <form action="<?= url_to('login') ?>" method="post">
                    ...
                    <?php if ($config->validFields === ['email']) : ?>
                      <div class="form-group mb-3">
                        <label class="mb-1" for="login"><?= lang('Auth.email') ?></label>
                    ...
                    <?php else : ?>
                      <div class="form-group mb-3">
                        <label class="mb-1" for="login">NIP</label>
                        <input type="text" class="form-control <?php if (session('errors.login')) : ?>is-invalid<?php endif ?>" name="login" placeholder="NIP">
                        <div class="invalid-feedback">
                          <?= session('errors.login') ?>
                        </div>
                      </div>
                    ...
                    <div class="form-group mb-3">
                      <label class="mb-1" for="password"><?= lang('Auth.password') ?></label>
